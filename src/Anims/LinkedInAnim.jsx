...
import animationData from './linkedin_anim.json'
...
const LinkedInAnimation = () => {
    ...
    useEffect(() => {
        function handleScroll() {
            ...
            setTimeout(() => {
                height = getHeightInPage(document.getElementsByClassName('contactIcon-linkedin')[0]) - window.outerHeight/2;
            }, 10);
    ...
    return (
        <div className='clip-container-linkedin'>
            ...
            <a
                ...
                href='https://www.linkedin.com/in/matt-neto'
                target='_blank'
                rel='noreferrer'>
            </a>
        </div >
